...
export function DecisionMomentSection() {
  ...
  const uiY = useTransform(scrollYProgress, [0.5, 1], [40, 0])

  return (
    <section ref={containerRef} className="relative py-32 sm:py-48 lg:py-64 bg-background overflow-hidden border-t border-border/30">
